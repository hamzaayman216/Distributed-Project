...
class Player():
    def __init__(self, x, y, width, height, image,score,game_over,holding_state):
        self.x = x
        self.y = y
        self.width = width
        self.height = height
...
def main():
    ...
    global screen, start_screen_image, track_image, car_image, enemy_car_image, score_text
    ...
    p = Player(startPos[0],startPos[1],100,100,car_image,0,0,0)
    p2=Player(0,0,100,100,car_image,0,0,0)
    ...
    while run:
        ...
        score_text = font.render(f'Score: {p.score}', True, (255, 255, 255))
